...
function setAttribute(dom, name, value) {
  ...
  if (/on\w+/.test(name)) {
    ...
    dom[name] = value || ''; // 如果属性名style则更新style对象
  } else if (name === 'style') {
...
function tick() {
  var element = React.createElement("div", null, React.createElement("h1", null, "Hello World"), React.createElement("h2", null, "Now Is ", new Date().toLocaleTimeString()));
